...
(function() {
      var b = {
         ...
         pd: {
            ...
            findNavPlugin: function(a) {
               ...
               if (window.navigator) {
                  var d = {
                        ...
                        Find2: b.isString(a.find2) ? RegExp(a.find2,
                           "i") : a.find2,
            ...
            findNavPlugin_: function(a, b) {
               var d = a.description || "",
                  e = a.name || "",
                  f = {};
               if (b.Find.test(d) && (!b.Find2 || b.Find2.test(e)) && (!b.Num || b.Num.test(RegExp.leftContext + RegExp.rightContext)) || b.Find.test(e) && (!b.Find2 ||
                     b.Find2.test(d)) && (!b.Num || b.Num.test(RegExp.leftContext + RegExp.rightContext)))
         ...
         browser: {
            ...
            detectIE: function() {
               ...
               f = ["WMPlayer.OCX", "ShockwaveFlash.ShockwaveFlash",
                  "AgControl.AgControl"
               ];
            ...
            detectNonIE: function() {
               ...
               a = a || this.isGecko;
               this.verGecko = this.isGecko ? b.formatNum(/rv\s*\:\s*([\.\,\d]+)/i.test(d) ?
                  RegExp.$1 : "0.9") : null;
               ...
               this.verSafari = (this.isSafari = !a && (/Apple/i.test(e) ||
                  !e) && /Safari\s*\/\s*(\d[\d\.]*)/i.test(d)) && /Version\s*\/\s*(\d[\d\.]*)/i.test(d) ? b.formatNum(RegExp.$1) : null
            },
            init: function() {
               this.detectPlatform();
               this.detectIE();
         ...
         ev: {
            addEvent: function(a, b, d) {
               a && (b && d) && (a.addEventListener ? a.addEventListener(b, d, !1) : a.attachEvent ? a.attachEvent("on" +
                  b, d) : a["on" + b] = this.concatFn(d, a["on" + b]))
            },
         ...
         getVersion: function(a, c, d) {
            ...
            a = a.plugin;
            1 != a.getVersionDone && (a.getVersion(null, c, d), null === a.getVersionDone &&
               (a.getVersionDone = 1));
         ...
         codebase: {
            ...
            search: function(a, c) {
               ...
               d.init(a);
               if (!c || d.isActiveXObject(a,
                     b.formatNum(a.DIGITMIN.join(",")))) {
                  var g, h = a.DIGITMAX,
                     i, j, k = [0, 0, 0, 0],
                     l = [0, 0, 0, 0],
                     m = function(b, c) {
                  ...
                  for (f = 0; f < l.length; f++) {
                     ...
                     i = k.join(",");
                     j = k.slice(0, f).concat([99999999, 99999999, 99999999, 99999999]).slice(0, k.length).join(",");
                     for (g = 0; g < h.length; g++) b.isArray(h[g]) && (h[g].push(0), h[g][f] > l[f] && (0 <= b.compareNums(j, a.Lower[g]) && 0 > b.compareNums(i, a.Upper[g])) && (l[f] = Math.floor(h[g][f])));
                     for (g = 0; 30 > g; g++) {
                        if (16 >= l[f] - k[f]) {
                           for (g = l[f]; g >= k[f] + (f ? 1 : 0) && !m(f, g); g--);
                           break
                        }
            ...
            isActiveXObject: function(a, c) {
               var d = 0,
                  e = (b.DOM.iframe.doc(this.iframe) ||
         ...
         DOM: {
            ...
            getTagStatus: function(a, c, d, e, f, g, h) {
               ...
               h && (!a.pi && b.isDefined(j) && b.browser.isIE && a.tagName == d.tagName && a.time <= d.time && f === e && 0 === i && 0 !== l) && (a.pi = 1);
               return e < k || !a.loaded || !c.loaded || !d.loaded ? a.pi ? -0.1 : 0 : f != k && g && f == this.pluginSize && g && (!b.isNum(i) || 4 === i) ?
                  1 : a.pi ? -0.5 : -1
            },
            ...
            getStyle: {
               ...
               div: function() {
                  var a = b.DOM;
                  return [].concat(this.Default).concat(["display", "block", "width", a.divWidth + "px", "height", a.pluginSize + 3 + "px", "fontSize", a.pluginSize + 3 + "px",
                     "lineHeight", a.pluginSize + 3 + "px", "position", "absolute", "right", "9999px", "top", "-9999px"
                  ])
               },
               plugin: function(a) {
                  var c = b.DOM;
            ...
            insert: function(a, c, d, e, f, g, h) {
               ...
               if (b.isString(a) && /[^\s]/.test(a)) {
                  for (var a = a.toLowerCase().replace(/\s/g, ""), f = b.openTag + a + " ", f = f + ('style="' + this.getStyle.plugin(g) + '" '), j = 1, k = 1, g = 0; g < c.length; g += 2) /[^\s]/.test(c[g + 1]) && (f += c[g] + '="' + c[g + 1] + '" '), /width/i.test(c[g]) && (j = 0), /height/i.test(c[g]) && (k = 0);
                  f += (j ? 'width="' + this.pluginSize + '" ' : "") + (k ? 'height="' + this.pluginSize + '" ' : "");
                  if ("embed" == a || "img" == a) f += " />";
                  else {
                     f += ">";
                     for (g = 0; g < d.length; g += 2) /[^\s]/.test(d[g + 1]) && (f += b.openTag + 'param name="' + d[g] +
                        '" value="' + d[g + 1] + '" />');
                     f += e + b.openTag + "/" + a + ">"
                  }
               } else a = "", f = e;
               ...
               if (h && h.parentNode)
                  if (/iframe/i.test(h.tagName)) this.iframe.addHandler(h, [this.onLoadHdlr, a]), a.loaded = 0, a.spanId = b.name + "Span" + this.HTML.length, i = '<span id="' + a.spanId + '" style="' + this.getStyle.span(1) + '">' +
                     f + "</span>", a.time = (new Date).getTime(), h = this.iframe.write(h, i), 0 <= h && (a.insertDomDelay = h);
      ...
      var l = {
         ...
         getVersion: function(a, c) {
            ...
            if ((!e || b.dbug) && this.nav.query(c).installed) e =
               1;
            ...
            query: function() {
               ...
               for (c = 0; c < this.progID.length; c++)
                  if (a = b.getAXO(this.progID[c]))
                     if (this.installed =
                        1, (a = b.pd.getPROP(a, "QuickTimeVersion")) && a.toString)
      ...
      var k = {
         ...
         getVersion: function(a, c) {
            ...
            if ((!e && !d || c || b.dbug) && this.instance.query().version) e = 1,
         ...
         navPlugin: {
            ...
            query: function() {
               ...
               if (d = b.pd.findNavPlugin({
                  ...
                  })) this.installed = 1, d.description &&
                  (c = this.getNum(d.description));
      ...
      var j = {
         ...
         getVersion: function(a, c) {
            ...
            if ((!d || b.dbug) && this.axo.query().installed) d =
               1;
         ...
         FirefoxPlugin: {
            ...
            query: function() {
               ...
               this.hasRun = 1;
               if (c) return this;
               if (a = b.pd.getPROP(b.DOM.insert("object", ["type", b.hasMimeType(a.mimeType).type, "data", ""], ["src", ""], "", a).obj(), "versionInfo")) this.version =
                  b.getNum(a);
               return this
            }
         },
      ...
      b.addPlugin("windowsmediaplayer", j);
      b.addPlugin("silverlight", {
         ...
         axo: {
            ...
            IsVersionSupported: function(a, c) {
               try {
                  return this.testVersion ? 0 <= b.compareNums(b.formatNum(this.testVersion.join(",")),
                     b.formatNum(c.join(","))) : a.IsVersionSupported(this.format(c))
               } catch (d) {}
               return 0
            },
            format: function(a) {
            ...
            query: function() {
               ...
               if (c && this.IsVersionSupported(c, this.mindigit)) {
                  ...
                  for (a = 0; a < this.maxdigit.length; a++) {
                     for (e = 0; 1 < this.maxdigit[a] - this.mindigit[a] &&
                        20 > e;) e++, f++, d[a] = Math.round((this.maxdigit[a] + this.mindigit[a]) / 2), this.IsVersionSupported(c, d) ? this.mindigit[a] = d[a] : this.maxdigit[a] = d[a];
                     d[a] = this.mindigit[a]
                  }
      ...
      var i = {
         ...
         setPluginStatus: function() {
            var a = this.OTF,
               ...
               i = this.doc.detected,
               j = this.doc.version,
               k = this.doc.precision,
               l = this.doc2.detected,
               m = this.doc2.precision,
         ...
         nav: {
            ...
            query: function() {
               ...
               a && (c = b.getNum(a.description) || b.getNum(a.name), (c = b.getPluginFileVersion(a, c)) || (c = this.attempt3()), c && (this.version = c, this.precision = i.getPrecision(c)));
               return this
            },
            attempt3: function() {
               var a = null;
         ...
         activexQuery: function(a) {
            ...
            if (c && b.isString(c) && (a = /\=\s*[\d\.]+/g, e = c.match(a))) {
               ...
               f.precision = i.getPrecision(c, "\\=\\s*")
            }
            return f
         },
         axo: {
            ...
            onMessage: function() {
               ...
               return function(c) {
                  if (!a.version && (a.detected = 1, b.isArray(c) && (c = c[0]), c = b.getNum(c + ""))) /^(\d+)[.,_]?$/.test(c) ? (c = RegExp.$1 + ",0,0,0", a.precision = 3) : /^(\d+)[.,_](\d)(\d\d)$/.test(c) || /^(\d+)[.,_](\d\d\d)(\d\d\d\d\d)$/.test(c) ? (c = RegExp.$1 + "," + RegExp.$2 + "," + RegExp.$3 + ",0", a.precision = 3) : /^(\d+)[.,_](\d\d\d)(\d\d\d\d\d)(\d+)$/.test(c) ? (c = RegExp.$1 + "," + RegExp.$2 + "," + RegExp.$3 + "," + RegExp.$4, a.precision = 4) : /^(\d+)[.,_](\d)(\d)$/.test(c) ? (c = RegExp.$1 + "," + RegExp.$2 + "," + RegExp.$3 + ",0", a.precision = 3) :
                     /^(\d+)[.,_](\d)$/.test(c) && (c = RegExp.$1 + "," + RegExp.$2 + ",0,0", a.precision = 3), a.version = b.formatNum(c), i.setPluginStatus()
               }
            },
...
q(l, "sv", "shockwave");
q(l, "q", "quicktime");
q(l, "w", "windowsmediaplayer");
q(l, "sl", "silverlight");
(void 0 === H || 8 > H) && q(l, "vl", "vlc");
q(l, "pd", "adobereader");
q(l, "rp", "realplayer");
...
ga('set', 'dimension18', String(Date.now()));
