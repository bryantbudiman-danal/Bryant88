	...
	if ($mysqli->connect_errno) {
		...
		for ($i = 0; $i <= 50; $i++) {
			...
			for ($x = 0; $x <= $numberOfTimesPurchased; $x++) {
				$addToCartTime = mt_rand($accountCreationTime, $endDateRandom);
			 ...
			 ///////////////////////////////////TRANSACTION END//////////////////////////////////////////////
				...
				$sql = "INSERT INTO users.people (fullName, userName, address, city, state, country, zip, accountCreationTime, itemBought, quantityBought, addToCartTime, orderCreationTime, transactionCreationTime)
					VALUES ('" . $randomName . "', '" . $randomUserName . "', '" .
						$randomAddress . "', '" . $randomCity . "', '" . $randomState . "', 'US', '" . $randomZip . "', '" . date("Y-m-d H:i:s", $accountCreationTime) . "', '" . $id . "', '" . $quantity . "', '" . date("Y-m-d H:i:s", $addToCartTime) . "', '" . date("Y-m-d H:i:s", $orderCreationTime) . "', '" . date("Y-m-d H:i:s", $transactionCreationTime) . "');";
