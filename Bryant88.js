...
ga('set', 'cd1', pluginsHash_);
ga('set', 'cd2', numPlugins_);
ga('set', 'cd3', platform_);
ga('set', 'cd4', mimeTypesHash_);
ga('set', 'cd5', numMimeTypes_);
ga('set', 'cd6', time_);
ga('set', 'cd7', timezoneOffset_);
ga('set', 'cd8', dstOffset_);
ga('set', 'cd9', cookieEnabled_);
ga('set', 'cd10', doNotTrack_);
ga('set', 'cd11', maxTouchPoints_);
ga('set', 'cd12', product_);
ga('set', 'cd13', productSub_);
ga('set', 'cd14', vendor_);
ga('set', 'cd15', vendorSub_);
ga('set', 'cd16', hardwareConcurrency_);
ga('set', 'cd17', online_);
ga('send', 'pageview');