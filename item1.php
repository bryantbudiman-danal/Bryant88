        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="row">
              <div class="col-md-4 thumbnail">
                <img src="img/asics1.0.jpg" alt="Item 1" class="image-responsive">
              </div>
              <div class="col-md-4 thumbnail">
                <img src="img/asics1.1.jpg" alt="Item 1" class="image-responsive">
              </div>
              <div class="col-md-4 thumbnail">
                <img src="img/asics1.2.jpg" alt="Item 1" class="image-responsive">
              </div>
            </div>

            <div class="row">
              <div class="col-md-4 thumbnail">
                <img src="img/asics1.3.jpg" alt="Item 1" class="image-responsive">
              </div>
              <div class="col-md-4 thumbnail">
                <img src="img/asics1.4.jpg" alt="Item 1" class="image-responsive">
              </div>
              <div class="col-md-4 thumbnail">
                <img src="img/asics1.5.jpg" alt="Item 1" class="image-responsive">
              </div>
            </div>

            <div class="row">
              <img src="img/asics1.0.jpg" alt="Item 1" class="image-responsive" id="main-image">
            </div>
          </div>
          <div class="col-md-5" id="right-container">
            ...
            <form action="add_to_cart.php" method="GET">
              ...
              <input type="hidden" id="itemID" name="id" value="1">
