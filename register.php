<?php
  ...
  $countryFullName = $countries[$consumerInfo["consumerInfo"]["consumerCountryCode"]];
        ...
        <div class="col-md-12 order-md-1">
          <form class="needs-validation" action="register-process.php" method="POST" novalidate >
            ...
            <div class="mb-3">
              ...
              <?php
                if(isset($_GET['phoneNumber'])) {
                  echo '<input type="text" name="city" class="form-control" id="city
                  " placeholder="' . $city . '" value="' . $city . '">';
                } else {
                  echo '<input type="text" name="city" class="form-control" id="city" placeholder="Townsville">';
                }
              ?>              
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-5 mb-3">
                ...
                <?php
                  if(isset($_GET['phoneNumber'])) {
                    echo '<input type="text" name="country" class="form-control" id="country" placeholder="' . $countryFullName . '" value="' . $country . '" required>';
                  } else {
                ?>
                <select class="custom-select d-block w-100" name ="country" id="country"><select>
